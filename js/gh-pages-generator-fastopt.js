...
/** @constructor */
ScalaJS.c.LApp$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.LApp$.prototype = new ScalaJS.h.O();
ScalaJS.c.LApp$.prototype.constructor = ScalaJS.c.LApp$;
/** @constructor */
ScalaJS.h.LApp$ = (function() {
  /*<skip>*/
});
ScalaJS.h.LApp$.prototype = ScalaJS.c.LApp$.prototype;
ScalaJS.c.LApp$.prototype.init___ = (function() {
  ScalaJS.n.LApp = this;
  return this
});
ScalaJS.c.LApp$.prototype.$$js$exported$meth$main__O = (function() {
  return (void 0)
});
ScalaJS.c.LApp$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
ScalaJS.is.LApp$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LApp$)))
});
ScalaJS.as.LApp$ = (function(obj) {
  return ((ScalaJS.is.LApp$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "App$"))
});
ScalaJS.isArrayOf.LApp$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LApp$)))
});
ScalaJS.asArrayOf.LApp$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LApp$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LApp$;", depth))
});
ScalaJS.d.LApp$ = new ScalaJS.ClassTypeData({
  LApp$: 0
}, false, "App$", ScalaJS.d.O, {
  LApp$: 1,
  sjs_js_JSApp: 1,
  O: 1
});
ScalaJS.c.LApp$.prototype.$classData = ScalaJS.d.LApp$;
ScalaJS.n.LApp = (void 0);
ScalaJS.m.LApp = (function() {
  if ((!ScalaJS.n.LApp)) {
    ScalaJS.n.LApp = new ScalaJS.c.LApp$().init___()
  };
  return ScalaJS.n.LApp
});
ScalaJS.e["App"] = ScalaJS.m.LApp;
/** @constructor */
...
//# sourceMappingURL=gh-pages-generator-fastopt.js.map
